---
title: "Aggregating covariates to windows counts in early period "
author: "T. Bataillon "
...
data100 <- readRDS(file = "output/data_100pb_pangolin_period1.rds")
dim(data100)
...
saveRDS(data100_susansmd, "output/data_100pb_pangolin_period1_withCovs.rds")
...
```{r}
counts_annotated <- readRDS("output/data_100pb_pangolin_period1_withCovs.rds")
